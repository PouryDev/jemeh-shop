...
|--------------------------------------------------------------------------
|
| These API routes are loaded for each tenant domain. All routes here
...
Route::middleware(['auth:sanctum', \App\Http\Middleware\EnsureUserIsTenantAdmin::class])->prefix('admin')->group(function () {
    // Dashboard
    ...
    // Template Settings
    Route::get('/template', [\App\Http\Controllers\Tenant\TemplateController::class, 'show']);
    Route::put('/template', [\App\Http\Controllers\Tenant\TemplateController::class, 'update']);
});
